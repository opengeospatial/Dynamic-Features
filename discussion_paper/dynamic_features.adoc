:Title: OGC Dynamic Features Discussion Paper
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/dp/DynamicFeatures/{m.n}
|Internal reference number of this OGC(R) document:    22-005
...
include::clause_6_dynamic_features.adoc[]

include::clause_6_10_recommendations.adoc[]
